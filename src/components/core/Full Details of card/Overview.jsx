            ...
            <div className=' px-5 py-8 rounded-3xl bg-[#D2F4E4] flex justify-around items-start w-9/12 mx-auto shadow-[0px_20px_50px_10px_#00000040]'>
                ...
                <div className='flex flex-col gap-2'>
                    ...
                    <div className='flex gap-2'>
                        ...
                        <p className='font-medium text-xl opacity-60'>{Data?.cardData?.bestFor?.name}</p>
                    </div>

                    <div className='flex gap-2'>
                        <p className='font-semibold text-xl'>Joining Fee: </p>
                        <p className='font-medium text-xl opacity-60'>{Data?.cardData?.charges[0]?.joiningFee}</p>
                    </div>

                    <div className='flex gap-2'>
                        <p className='font-semibold text-xl'>Annual Fee:</p>
                        <p className='font-medium text-xl opacity-60'>{Data?.cardData?.charges[0]?.annualFee}</p>
                    </div>
                </div>
