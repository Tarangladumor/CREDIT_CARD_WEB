    ...
    <div>
      <header className='flex justify-start items-center gap-2 w-10/12 mx-auto mb-5'>
        ...
        <div className='flex flex-col'>
          ...
          <p className='text-[#0000008A] text-[20px] leading-[30px]'>Don't worry, we will not publish your email address. Each section is mandatory.</p>
        </div>
      </header>
