...
import { fetchAllCardByPrivilege } from '../../../services/Operations/cardAPI';
import CardDetails from '../../common/CardDetails';
import { useLocation } from 'react-router-dom';

const CardsByPrivilege = () => {

    let location = useLocation();

    const pathParts = location.pathname.split('/');
    const privilegeId = pathParts[pathParts.length - 1];
    console.log("ID>>>>>>>>>>>>>>", privilegeId);
...
export default CardsByPrivilege
