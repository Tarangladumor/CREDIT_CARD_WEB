...
const CardDetails = ({ Data }) => {
  ...
  return (
    <div className="relative">
      ...
      <div
        className={`bg-[#D2F4E4] flex flex-col gap-5 rounded-tr-3xl rounded-bl-3xl transition-all duration-300 ease-in-out relative ${
          isHovered ? "h-auto z-20 scale-105 shadow-2xl" : "h-[500px]"
      ...
      >
        ...
        {isHovered && (
          <div
            className={`flex flex-col gap-2 px-12 pb-10 transition-all duration-300 ease-in-out ${
              isHovered ? "max-h-screen" : "max-h-0 overflow-hidden"
            }`}
          >
