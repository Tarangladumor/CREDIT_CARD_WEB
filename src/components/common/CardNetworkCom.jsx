    ...
    <div>
      <div className='flex flex-col md:flex-row items-center justify-center m-4'>
        <div className='flex flex-col items-center md:items-start'>
          <img src={img} alt="" className='h-[100px] w-[120px] md:h-[150px] md:w-[170px]' />
          <div className='w-[60%] mt-[-30px] md:mt-[-50px] ml-0 md:ml-7'>
      ...
      <div className='hidden md:flex flex-col justify-center items-center w-[90%] mx-auto'>
        <div className='text-base md:text-lg'>{desc2}</div>
